      ...
      >
        ...
        <div className="bg-slate-950 px-6 py-6 text-white relative">
          ...
          <p className="text-xs text-slate-400 mt-1">
            Sign in with your Google account to access your photographer dashboard.
          </p>
        </div>
        ...
        <div className="p-6 space-y-5">
          ...
          {/* Single Google OAuth Sign In Option */}
          <div>
            <button
              type="button"
              onClick={handleGoogleSignIn}
              disabled={isSubmitting}
              className="w-full py-3 px-4 bg-slate-900 hover:bg-slate-800 text-white font-medium text-xs rounded-lg transition-colors flex items-center justify-center space-x-3 shadow-md cursor-pointer disabled:opacity-50"
            >
